...
class RulesTests(unittest.TestCase):
    ...
    def test_get_word_points(self):
        word = Word([Tile("O", (1, 0)), Tile("F", (2, 0))])
        self.assertEqual(word.get_points(self.board), 5)
...
class WordTests(unittest.TestCase):
    ...
    def test_get_word_borders(self):
        ...
        self.assertEqual(word.get_borders(), borders)
...
class PlayerTests(unittest.TestCase):
    ...
    def test_sum_points(self):
        ...
        letters = Dictionary(self.board.language).letters
        self.assertEqual(self.player1.points, letters["O"] + letters["F"])
        self.assertEqual(self.player2.points, letters["O"] + letters["F"])
    ...
    def test_extend_vertical_word_points(self):
        ...
        letters = Dictionary(self.board.language).letters
        self.assertEqual(self.player1.points, word.get_points(self.board))
        self.assertEqual(self.player2.points, word.get_points(self.board) + letters["S"])
    ...
    def test_two_words_points(self):
        ...
        self.assertEqual(
            self.player2.points,
            word_2.get_points(self.board) * 2 + word.get_points(self.board),
        )
    ...
    def test_double_extend_word_points(self):
        ...
        self.assertEqual(self.player1.points, word.get_points(self.board))
        self.assertEqual(self.player2.points, word_2.get_points(self.board))
...
class DictTests(unittest.TestCase):
    ...
    def test_word_not_in_dict_spanish(self):
        self.assertFalse("xyzzy" in Dictionary("spanish"))
...
class RandomTilesTests(unittest.TestCase):
    ...
    def test_random_tiles(self):
        self.assertEqual(7, len(self.board.get_random_tiles()))
        self.assertEqual(1, len(self.board.get_random_tiles(1)))
    ...
    def test_all_tiles(self):
        ...
        for letter, quantity in self.board.tiles_quantity.items():
            self.assertEqual(letters.count(letter), quantity)
